...
if __name__ == '__main__':
	...
	input = sys.argv[1]
	# input = 'My name is Sanjana'
	inputList = []
	output1 = open('BigramProbability_OUTPUT.txt', 'w')
	output2 = open('AddOneSmoothing_OUTPUT.txt', 'w')
	output3 = open('GoodTuringDiscounting_OUTPUT.txt', 'w')
	outputProb1 = 1
	outputProb2 = 1
	outputProb3 = 1
	...
	# ---------------------------- Calulation of Good Turing Discounting ------------------------------
